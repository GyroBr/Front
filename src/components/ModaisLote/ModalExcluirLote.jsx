...
import styles from "./ModalExcluirLote.module.css";

export default function ModalExcluirLote({ isOpen, setModalOpen, productId, onDeleteSuccess }) {
...
// Compare this snippet from Front/src/components/CardEstoque/CardEstoque.jsx: